...
class ImageEncoderViT(BaseModel):
    def __init__(
        self,
        args,
        img_size: int = 1024,
        ...
        self.args = args
        self.emb_dim = out_chans
        self.pixel_mean = torch.asarray(pixel_mean)
        self.pixel_std = torch.asarray(pixel_std)
    ...
    def encode(self, x: torch.Tensor, prepool: bool = False, prehead: bool = False) -> torch.Tensor:
        # TODO: change h value to img height/ patch height
